window.POSTERS = [
  ...
  {
    id: "carbon-neutral-ia-2025",
    title: "탄소중립 INNOVATION ACADEMY 4기 개인 프로젝트",
    award: "우수상",
    awardTitle: "SW중심대학사업단장상",
    organizer: "인하대학교 SW중심대학사업단",
    awardDate: "2025. 6. 23.",
    ...
    images: Array.from({ length: 14 }, (_, index) => {
      ...
      return {
        src: `/assets/carbon-neutral-ia-2025-${page}.jpg`,
        width: 3200,
        height: 1800,
        alt: `탄소중립 INNOVATION ACADEMY 4기 개인 프로젝트 최종발표 슬라이드 ${index + 1}`,
      };
    }),
  },
  {
  ...
  {
    id: "carbon-neutral-team-ia-2024",
    title: "탄소중립 INNOVATION ACADEMY 3기 팀 프로젝트",
    award: "대상",
    awardTitle: "인하대학교 총장상",
    organizer: "인하대학교 SW중심대학사업단",
    awardDate: "2024. 12. 23.",
    author: "김준호",
    images: Array.from({ length: 21 }, (_, index) => {
      const page = String(index + 1).padStart(2, "0");
      return {
        src: `/assets/carbon-neutral-team-ia-2024-${page}.jpg`,
        width: 3200,
        height: 1800,
        alt: `탄소중립 INNOVATION ACADEMY 3기 팀 프로젝트 최종발표 슬라이드 ${index + 1}`,
      };
    }),
  },
  {
